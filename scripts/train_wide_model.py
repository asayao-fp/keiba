...
train_wide_model.py
===================
学習データ CSV を読み込んで CatBoostClassifier でワイドモデルを学習する。
...
DEFAULT_TRAIN_CSV = "data/wide_train.csv"
DEFAULT_MODEL_OUT = "models/wide_model.cbm"
...
# 識別用列 (特徴量に含めない)
ID_COLS = ["race_key", "yyyymmdd", "horse_no_a", "horse_no_b"]


def parse_args():
    parser = argparse.ArgumentParser(
        description="is_wide 予測モデルを CatBoost で学習する"
    )
    parser.add_argument(
        "--train-csv",
