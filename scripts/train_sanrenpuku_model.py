"""
train_sanrenpuku_model.py
=========================
学習データ CSV を読み込んで CatBoostClassifier で3連複モデルを学習する。
...
DEFAULT_TRAIN_CSV = "data/sanrenpuku_train.csv"
DEFAULT_MODEL_OUT = "models/sanrenpuku_model.cbm"
...
TARGET_COL = "is_sanrenpuku"

# 識別用列 (特徴量に含めない)
ID_COLS = ["race_key", "yyyymmdd", "horse_no_a", "horse_no_b", "horse_no_c"]


def parse_args():
    parser = argparse.ArgumentParser(
        description="is_sanrenpuku 予測モデルを CatBoost で学習する"
    )
    parser.add_argument(
        "--train-csv",
